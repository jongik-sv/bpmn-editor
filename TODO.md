...
### 3.1 Y-Supabase 기반 실시간 협업 (Priority: 🔴 Critical)
- [ ] **Y-Supabase 설치 및 설정**: `npm install y-supabase`
- [ ] **SupabaseProvider 통합**: Y.Doc과 Supabase 연결
- [ ] **실시간 동기화**: 문서 변경사항 실시간 동기화
- [ ] **Awareness 구현**: 사용자 커서 및 선택 상태 공유
